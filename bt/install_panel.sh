...
Install_RPM_Pack(){
	...
	#	curl -Ss --connect-timeout 3 -m 60 https://raw.githubusercontent.com/bstlx/only/lucky/bt/yumRepo_select.sh|bash
	#fi
...
Install_Python_Lib(){
	curl -Ss --connect-timeout 3 -m 60 https://raw.githubusercontent.com/bstlx/only/lucky/bt/pip_select.sh|bash
...
Install_Bt(){
	...
	wget -O /etc/init.d/bt https://raw.githubusercontent.com/bstlx/only/lucky/bt/bt6.init -T 10
	wget -O /www/server/panel/install/public.sh https://raw.githubusercontent.com/bstlx/only/lucky/bt/public.sh -T 10
	wget -O panel.zip https://raw.githubusercontent.com/bstlx/only/lucky/bt/panel6.zip -T 10
	...
	wget -O /etc/init.d/bt https://raw.githubusercontent.com/bstlx/only/lucky/bt/bt7.init -T 10
	wget -O /www/server/panel/init.sh https://raw.githubusercontent.com/bstlx/only/lucky/bt/bt7.init -T 10
